...
|---|---|---|
| **anvil** (motor, cargador, modelo, expr, result_sink, host) | **AGPL-3.0-or-later** | Es el producto: se *usa*, no se linka. La AGPL impide que alguien lo cierre y lo revenda. |
