...
```sh
curl -LO https://github.com/anlaco/anvil/releases/download/v0.6.2/anvil-v0.6.2-x86_64-linux-musl.tar.gz
tar xzf anvil-v0.6.2-x86_64-linux-musl.tar.gz
cd anvil-v0.6.2-x86_64-linux-musl
